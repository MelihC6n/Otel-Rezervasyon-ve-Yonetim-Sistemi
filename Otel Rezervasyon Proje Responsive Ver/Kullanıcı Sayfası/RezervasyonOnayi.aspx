                 ...
                 <div class="row">
                     ...
                     <div class="col-12 col-sm-12 col-md-6 tableBaslik">İndirim Oranı<br /><br /><asp:label text='<%#Eval("indirimOrani") %>' runat="server" Font-Bold="true" ForeColor="#ff6a00"/></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
         <div style="height: 40px; overflow: hidden; display: inline-block;"><a href="#" data-hover="Ana Sayfaya Dön" class="rez" runat="server"  id="btnAnaSayfa" onserverclick="AnaSayfa_Click">Ana Sayfaya Dön</a>&nbsp&nbsp<asp:Label runat="server" ID="lblOnay" Visible="False" ForeColor="#32C867"></asp:Label><br /><br /><br />         
</div> 
                            </div>
                        </div>

           
                </div></div>        </div>  <div class="col col-sm col-md-1"></div>       </div> <div class="col-auto col-sm-3"></div> </div>
