						...
						<div class="widget-shadow " data-example-id="basic-forms"> 
                            ...
                            <div class="form-body">
                             ...
                             <div class="col-sm-9">
                                ...
                                <div class="col-sm-9">
                                    <asp:FileUpload runat="server" ID="fuFotograf" /><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Lütfen bu alanı boş bırakmayınız." ControlToValidate="fuFotograf" ForeColor="Red"></asp:RequiredFieldValidator><br />
                                    ...
                                    <asp:Image runat="server" ID="odaTipFotograf" Width="100" Height="100" />
